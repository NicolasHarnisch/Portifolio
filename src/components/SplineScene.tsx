...
export default function SplineScene() {
  ...
  return (
    <div className="relative w-full aspect-square max-w-[14rem] sm:max-w-[18rem] md:max-w-[22rem] lg:max-w-[28rem] max-h-[60vh] overflow-hidden" aria-hidden="true" role="presentation">
