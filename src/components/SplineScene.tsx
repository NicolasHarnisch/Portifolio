...
export default function SplineScene() {
  ...
  return (
    <div className="relative w-full aspect-square max-w-[14rem] sm:max-w-[22rem] md:max-w-[26rem] lg:max-w-[32.5rem] max-h-[70vh] overflow-hidden" aria-hidden="true" role="presentation">
