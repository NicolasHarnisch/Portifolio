...
const Hero = () => {
  ...
  const links = {
    curriculo:
      "https://drive.google.com/file/d/1y6GDWAJMyIpAZW49UwM49GMbY5C0aiU8/view?usp=sharing",
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden px-4 sm:px-6">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% -20%, hsl(262 100% 71% / 0.3), transparent)",
        }}
      />

      <div className="absolute top-20 right-1/4 w-48 sm:w-72 h-48 sm:h-72 rounded-full bg-primary/10 blur-3xl animate-float" />
      <div
        className="absolute bottom-20 left-1/4 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-primary/5 blur-3xl animate-float"
      ...
      <div className="container relative z-10 pt-24 sm:pt-20 pb-12">
        <div className="max-w-4xl mx-auto text-center md:text-left md:mx-0">
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold leading-tight mb-4 sm:mb-6 animate-fade-up text-foreground">
            Nícolas Gomes
            <br />
